...
function Doctor(params) {
    ...
    return (
        <ScrollView contentContainerStyle={[styles.subContainer, { marginTop: 10 }]} showsVerticalScrollIndicator={false}>
            {[1, 2, 3, 4].map((_, index) => (
    ...
    return (
        <View style={styles.container}>
            <View style={styles.subContainer}>
                <Header leftIconName children={SearchBar} childrenStyle={styles.childrenSTyle} marginTop={20} />
            </View>
